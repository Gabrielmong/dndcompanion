...
export interface Context {
  prisma: PrismaClient
  loaders: Loaders
  user: { id: string; email: string; name: string; passwordHash: string | null; googleId: string | null; dateOfBirth: Date | null; avatarUrl: string | null; emailVerified: boolean; createdAt: Date; updatedAt: Date } | null
}
